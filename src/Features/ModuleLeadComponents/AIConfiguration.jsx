                        ...
                        <div className="mlp-aiconfig-btn-group">
                            {["Short", "Balanced", "Detailed"].map((opt) => (
                                <button
                                    key={opt}
                                    type="button"
                                    className={`mlp-aiconfig-pill-btn ${settings.answerLength === opt ? "active" : ""
                                        }`}
                        ...
                        <div className="mlp-aiconfig-btn-group">
                            {["Direct", "Neutral", "Formal"].map((opt) => (
                                <button
                                    key={opt}
                                    type="button"
                                    className={`mlp-aiconfig-pill-btn ${settings.tone === opt ? "active" : ""
                                        }`}
                        ...
                        <div className="mlp-aiconfig-btn-group two-col">
                            {["My tickets", "My customers"].map((opt) => (
                                <button
                                    key={opt}
                                    type="button"
                                    className={`mlp-aiconfig-pill-btn ${settings.dataScope === opt ? "active" : ""
                                        }`}
