...
const DeliveryWorkflow = ({
  ...
  const [ackResponsibleBy, setAckResponsibleBy] = useState("");
  const [ackStatus, setAckStatus] = useState("Assigned");
  ...
  const [stepsState, setStepsState] = useState({
    step2: { days: 2, startDate: "09/14/2026", responsible: "", status: "Closed", attachment: null, attachmentName: "" },
    step3: { days: 2, startDate: "09/16/2026", responsible: "", status: "Inprocess", attachment: null, attachmentName: "" },
    step4: { days: 3, startDate: "09/18/2026", responsible: "", status: "Assigned", attachment: null, attachmentName: "" },
    step5: { days: 3, startDate: "09/23/2026", responsible: "", status: "Assigned", attachment: null, attachmentName: "" },
    step6: { days: 4, startDate: "09/28/2026", responsible: "", status: "Assigned", attachment: null, attachmentName: "" },
    step7: { days: 5, startDate: "10/02/2026", responsible: "", status: "Assigned", attachment: null, attachmentName: "" },
    step8: { days: 2, startDate: "10/07/2026", responsible: "", status: "Assigned", attachment: null, attachmentName: "" },
    step9: { days: 1, startDate: "10/09/2026", responsible: "", status: "Assigned", attachment: null, attachmentName: "" },
    step10: { days: 3, startDate: "10/12/2026", responsible: "", status: "Assigned", attachment: null, attachmentName: "" },
  });
  ...
  useEffect(() => {
    if (selectedWorkflowTicket) {
      const defaultName = selectedWorkflowTicket.name || (employees && employees.length > 0 ? (employees[0].name || employees[0].employeeName) : "K. Menon");
      const defaultStatus = selectedWorkflowTicket.ticketStatus || (statuses && statuses.length > 0 ? statuses[0].name : "Assigned");

      if (selectedWorkflowTicket.name) {
        setAckResponsibleBy(selectedWorkflowTicket.name);
      } else if (employees && employees.length > 0) {
        setAckResponsibleBy(employees[0].name || employees[0].employeeName || "K. Menon");
      }

      if (selectedWorkflowTicket.ticketStatus) {
        setAckStatus(selectedWorkflowTicket.ticketStatus);
      } else if (statuses && statuses.length > 0) {
        setAckStatus(statuses[0].name || "Assigned");
      }

      setStepsState((prev) => ({
        step2: { ...prev.step2, responsible: prev.step2.responsible || defaultName },
        step3: { ...prev.step3, responsible: prev.step3.responsible || defaultName },
        step4: { ...prev.step4, responsible: prev.step4.responsible || defaultName },
        step5: { ...prev.step5, responsible: prev.step5.responsible || defaultName },
        step6: { ...prev.step6, responsible: prev.step6.responsible || defaultName },
        step7: { ...prev.step7, responsible: prev.step7.responsible || defaultName },
        step8: { ...prev.step8, responsible: prev.step8.responsible || defaultName },
        step9: { ...prev.step9, responsible: prev.step9.responsible || defaultName },
        step10: { ...prev.step10, responsible: prev.step10.responsible || defaultName },
      }));
    }
  ...
  const handleSaveStep = async (stepKey, docType) => {
    ...
    if (stepKey === "step1") {
      ...
      responsibleVal = s.responsible || selectedWorkflowTicket?.name || "K. Menon";
  ...
  const renderEmployeeOptions = (currentValue) => {
    ...
    if (currentValue && !list.some((item) => item.name.toLowerCase() === String(currentValue).toLowerCase())) {
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth error={missingFields.includes("Responsible By")}>
                ...
                >
                  ...
                  {renderEmployeeOptions(ackResponsibleBy)}
                </Select>
              </FormControl>
            </div>
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step2.responsible || selectedWorkflowTicket?.name || "K. Menon"}
                  onChange={(e) => handleStepChange("step2", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step2.responsible || selectedWorkflowTicket?.name || "K. Menon")}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
        ...
        <div className="mlp-dw-step-card">
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step3.responsible || selectedWorkflowTicket?.name}
                  onChange={(e) => handleStepChange("step3", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step3.responsible || selectedWorkflowTicket?.name)}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
        ...
        <div className="mlp-dw-step-card">
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step4.responsible || selectedWorkflowTicket?.name}
                  onChange={(e) => handleStepChange("step4", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step4.responsible || selectedWorkflowTicket?.name)}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
        ...
        <div className="mlp-dw-step-card">
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step5.responsible || selectedWorkflowTicket?.name}
                  onChange={(e) => handleStepChange("step5", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step5.responsible || selectedWorkflowTicket?.name)}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
        ...
        <div className="mlp-dw-step-card">
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step6.responsible || selectedWorkflowTicket?.name}
                  onChange={(e) => handleStepChange("step6", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step6.responsible || selectedWorkflowTicket?.name)}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
        ...
        <div className="mlp-dw-step-card">
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step7.responsible || selectedWorkflowTicket?.name}
                  onChange={(e) => handleStepChange("step7", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step7.responsible || selectedWorkflowTicket?.name)}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
        ...
        <div className="mlp-dw-step-card">
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step8.responsible || selectedWorkflowTicket?.name}
                  onChange={(e) => handleStepChange("step8", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step8.responsible || selectedWorkflowTicket?.name)}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
        ...
        <div className="mlp-dw-step-card">
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step9.responsible || selectedWorkflowTicket?.name}
                  onChange={(e) => handleStepChange("step9", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step9.responsible || selectedWorkflowTicket?.name)}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
        ...
        <div className="mlp-dw-step-card">
          ...
          <div className="mlp-dw-form-row">
            ...
            <div className="mlp-dw-field-group">
              ...
              <FormControl size="small" fullWidth>
                <Select
                  value={stepsState.step10.responsible || selectedWorkflowTicket?.name}
                  onChange={(e) => handleStepChange("step10", "responsible", e.target.value)}
                  sx={muiSelectSx}
                  MenuProps={menuProps}
                >
                  {renderEmployeeOptions(stepsState.step10.responsible || selectedWorkflowTicket?.name)}
                </Select>
              </FormControl>
            </div>
            <div className="mlp-dw-field-group">
